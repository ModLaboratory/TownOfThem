...
There're no role or gamemode implemented.

-----------------

## Chinese / 中文

[原README文件](README_Origin.md)

此模组已与 [Clash Of Gods](https://github.com/CognifyDev/ClashOfGods) 合并，且此仓库不会再更新。请考虑去支持新模组，点个Star！

模组的代码有亿点烂（特别是以前提交的），最好别去参考或引用，因为我当时太垃圾了，都是别处借(fu)鉴(zhi)的！
